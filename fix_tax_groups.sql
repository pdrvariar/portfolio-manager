...
ALTER TABLE system_assets MODIFY COLUMN tax_group ENUM('RENDA_FIXA', 'ETF_BR', 'CRIPTOMOEDA', 'FUNDO_IMOBILIARIO', 'ETF_US', 'NAO_APLICAVEL') DEFAULT 'RENDA_FIXA';
...
-- Os grupos ACAO_BR e ETF_USA foram removidos conforme solicitação do usuário.
